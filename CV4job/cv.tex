...
Theoretical foundations of machine learning, with an emphasis on \textbf{optimization theory and scaling laws}, \textbf{LLM reasoning and post-training}, and \textbf{applications of AI}.

%-------------------------------------------------------------------------------
\section{Education}
\datedentry{\textbf{The Wharton School, University of Pennsylvania}}{Aug. 2026 -- Present}
\vspace{-2pt}
...
\datedentry{\textbf{Tencent Hy -- Qingyun Talent Program} \quad \textit{Research Intern, Beijing}}{Jun. 2026 -- Aug. 2026}

%-------------------------------------------------------------------------------
\section{Publications}
[1] \textbf{Zixun Huang*}, Jiayi Sheng*, Zeyu Zheng. \textit{Variance-Aware Baselines and Adaptive Learning Rates for Reinforcement Learning with Verifiable Rewards}. \textbf{Under review}. \href{https://arxiv.org/abs/2511.23310}{[Paper]}

[2] Yuhao Sun, Zekun Wu, \textbf{Zixun Huang}, Peijie Zhou. \textit{TracingFlow: A Simulation-Free Trajectory Inference Framework Based on Second-Order Dynamics}. \textbf{Under review}.

[3] Binghui Li*, Fengling Chen*, \textbf{Zixun Huang*}, Lean Wang*, Lei Wu. \textit{Functional Scaling Laws in Kernel Regression: Loss Dynamics and Learning Rate Schedules}. \textbf{NeurIPS 2025 Spotlight}. \href{https://arxiv.org/abs/2509.19189}{[Paper]} {\footnotesize * Equal contribution.}

%-------------------------------------------------------------------------------
\section{Research Experience}
\datedentry{\textbf{University of California, Berkeley} \quad \textit{Research Intern, Berkeley, CA}}{Jan. 2025 -- Aug. 2025}
\vspace{-2pt}
\hspace{1em}\textit{Supervisor: Associate Professor Zeyu Zheng}

\datedentry{\textbf{Peking University} \quad \textit{Research Intern, Beijing}}{May 2023 -- Aug. 2026}
\vspace{-2pt}
