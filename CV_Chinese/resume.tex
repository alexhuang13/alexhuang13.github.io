...
\begin{center}
    ...
    \textcolor{linkcolour}{\faWeixin\ 微信：18952009927}}
\end{center}
\vspace{-9pt}
...
%-------------------------------------------------------------------------------
\section{论文发表}
[1] Jia-Nan Wang*, \textbf{Zixun Huang*}, Kairui Li*, Lei Wu. \textit{Momentum in Large-Batch Training: Polyak Enlarges the Critical Batch Size, Nesterov Improves Data Efficiency}. \textbf{预印本}。\href{https://arxiv.org/pdf/2609.02728}{[论文]}

[2] \textbf{Zixun Huang*}, Kishan Panaganti*, Haitao Mi, Leowei Liang. \textit{FlowBalance: Verifier-Grounded Self-Improvement from On-Policy Reasoning Experience}. \textbf{预印本}。\href{https://github.com/alexhuang13/FlowBalance}{[GitHub]} \href{https://alexhuang13.github.io/FlowBalance-Blog/}{[博客]}

[3] Zhongzhi Li*, Yucheng Shi*, Zongxia Li*, Ruhan Wang, Anhao Li, \textbf{Zixun Huang}, Junyao Yang, Lei Ke, Ninghao Liu, Haitao Mi, Leowei Liang. \textit{Recursive Synthesis for Long-Horizon Terminal Tasks}. \textbf{预印本}。\href{https://arxiv.org/abs/2608.05466}{[论文]} \href{https://huggingface.co/collections/Zhongzhi1228/recursive-synthesis-for-long-horizon-terminal-tasks}{[Hugging Face]} \href{https://zhongzhi660.github.io/recursive-verified-synthesis-site/?case=jobs-diff-01-3341b098}{[项目主页]}
...
[5] Yuhao Sun, Zekun Wu, \textbf{Zixun Huang}, Peijie Zhou. \textit{TracingFlow: A Simulation-Free Trajectory Inference Framework Based on Second-Order Dynamics}. \textbf{审稿中}。\href{https://arxiv.org/pdf/2608.21070}{[论文]}
...
\begin{itemize}\setlength\itemsep{1pt}\setlength\topsep{2pt}\setlength\parsep{0pt}\setlength\parskip{0pt}\small
  \item \textbf{验证器引导的自我改进 [2]：}提出 FlowBalance，通过轨迹平衡将验证器优势与特权后见自引导相结合，学习完整回答上的归一化分布；在五个推理基准上，Qwen3-4B 与 Qwen3-8B 相较 GRPO 的平均表现分别提升 \textbf{1.95} 和 \textbf{2.12 个百分点}，同时显著增加成功解答之间的语义策略多样性。
