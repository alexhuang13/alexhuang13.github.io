...
%-------------------------------------------------------------------------------
\section{论文发表}
[1] Jia-Nan Wang*, \textbf{Zixun Huang*}, Kairui Li*, Lei Wu. \textit{Momentum in Large-Batch Training: Polyak Enlarges the Critical Batch Size, Nesterov Improves Data Efficiency}. \textbf{预印本}。
